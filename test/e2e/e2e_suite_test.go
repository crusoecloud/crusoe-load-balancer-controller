...
var (
	...
	projectImage = "example.com/crusoe-load-balancer-controller:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting crusoe-load-balancer-controller integration test suite\n")
